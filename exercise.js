...
var placeLength = longestPlaceName.length;
...
var placePhrase = longestPlaceName + " is the longest place name in the word and has " + placeLength + " letters in its name.";
console.log("placePhrase:", placePhrase);
...
console.log("worldLocator:", worldLocator);
...
console.log("smallKine: ", smallKine);
